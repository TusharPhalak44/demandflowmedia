...
$basePermissions = [
    ...
    'tasks.access' => 'Tasks – Access',
    'tasks.create' => 'Tasks – Create',
    'tasks.manage' => 'Tasks – Manage',
    'tasks.assign' => 'Tasks – Assign/Reassign',
    'tasks.override' => 'Tasks – Override/Close',
...
$basePermissionGroups = [
    ...
    'Task Management' => ['tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.override','tasks.reports'],
...
$default = [
    ...
    'operations_director' => ['dashboard.operations','notifications.access','chat.access','leads.manage','leads.export','leads.entry','leads.bulk_upload','leads.tracking','campaigns.view','campaigns.export','clients.access','vendors.access','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'operations_manager' => ['dashboard.operations','notifications.access','chat.access','leads.manage','leads.export','leads.entry','leads.bulk_upload','leads.tracking','campaigns.view','campaigns.export','clients.access','vendors.access','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'operations_agent' => ['dashboard.operations','notifications.access','chat.access','leads.manage','leads.entry','leads.my','campaigns.view','tasks.access'],
    'agent' => ['dashboard.operations','notifications.access','chat.access','leads.entry','leads.my','campaigns.view','tasks.access'],
    'email_marketing_director' => ['dashboard.marketing','notifications.access','chat.access','leads.manage','leads.entry','leads.marketing','leads.email','campaigns.view','campaigns.export','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'email_marketing_manager' => ['dashboard.marketing','notifications.access','chat.access','leads.manage','leads.entry','leads.marketing','leads.email','campaigns.view','campaigns.export','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'email_marketing_agent' => ['dashboard.marketing','notifications.access','chat.access','leads.manage','leads.entry','leads.marketing','leads.email','campaigns.view','tasks.access'],
    'email_marketing_executive' => ['dashboard.marketing','notifications.access','chat.access','leads.manage','leads.entry','leads.marketing','leads.email','campaigns.view','tasks.access'],
    'qa_director' => ['dashboard.qa','notifications.access','chat.access','qa.access','qa.assignments','leads.view','leads.export','campaigns.view','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'qa_manager' => ['dashboard.qa','notifications.access','chat.access','qa.access','qa.assignments','leads.view','campaigns.view','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'qa_agent' => ['dashboard.qa','notifications.access','chat.access','qa.access','leads.view','campaigns.view','tasks.access'],
    'qa' => ['dashboard.qa','notifications.access','chat.access','qa.access','leads.view','campaigns.view','tasks.access'],
    'sales_director' => ['dashboard.sales','notifications.access','chat.access','sales.access','campaigns.view','leads.view','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'sales_manager' => ['dashboard.sales','notifications.access','chat.access','sales.access','campaigns.view','leads.view','tasks.access','tasks.create','tasks.manage','tasks.assign','tasks.reports'],
    'sdr' => ['dashboard.sales','notifications.access','chat.access','sales.access','leads.view','tasks.access'],
    'form_filler' => ['dashboard.marketing','notifications.access','chat.access','leads.entry','leads.marketing','campaigns.view','tasks.access'],
