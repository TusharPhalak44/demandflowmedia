...
$totalMql = (float)($stats['total_mql'] ?? 0);
$overallPercent = (float)($stats['overall_percent'] ?? 0);
$daysMetDaily = (int)($stats['days_met_daily'] ?? 0);
$metMonthly = (bool)($stats['met_monthly'] ?? false);
$isLocked = !empty($stats['locked']);
...
<?php else: ?>
    <div class="row g-3 mb-3">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-light fw-semibold d-flex justify-content-between align-items-center">
                    <span>Summary</span>
                    <?php if ($isLocked): ?>
                        <span class="badge bg-danger">Payroll Locked</span>
                    <?php endif; ?>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-2 h-100">
                                <div class="text-muted small">Total MQL Achieved</div>
                                <div class="fs-5 fw-semibold"><?php echo number_format($totalMql, 2); ?></div>
                                <div class="text-muted small">Delivered leads only</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border rounded p-2 h-100">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-2 h-100">
                                <div class="text-muted small">Days Met Target</div>
                                <div class="fs-5 fw-semibold"><?php echo number_format($daysMetDaily); ?> / <?php echo number_format($daysElapsed); ?></div>
                                <div class="text-muted small">Daily % ≥ 100</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border rounded p-2 h-100">
                                <div class="text-muted small">Delivered Leads (Count)</div>
                                <div class="fs-5 fw-semibold"><?php echo number_format($totalLeads); ?></div>
                                <div class="text-muted small">All campaign types</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border rounded p-2 h-100">
                                <div class="text-muted small">Monthly Incentive (>=90%)</div>
                                <div class="fs-5 fw-semibold"><?php echo $metMonthly ? 'Eligible' : 'Not Eligible'; ?></div>
                                <div class="text-muted small">Rs. <?php echo number_format($monthlyInc, 0); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 border-top pt-3">
                        <div class="row g-2">
                            <div class="col-md-4">
                                <div class="text-muted small">Daily Incentives (Total)</div>
                                <div class="fw-semibold">Rs. <?php echo number_format($dailyIncTotal, 0); ?></div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-muted small">Monthly Incentive</div>
                                <div class="fw-semibold">Rs. <?php echo number_format($monthlyInc, 0); ?></div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-muted small">Total Incentives</div>
                                <div class="fw-semibold">Rs. <?php echo number_format($totalInc, 0); ?></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-light fw-semibold">Conversions & Rules</div>
                <div class="card-body">
                    <div class="small text-muted mb-2">Only Delivered leads count.</div>
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered mb-3">
                            <thead class="table-light">
                                <tr>
                                    <th>Type</th>
                                    <th class="text-end">MQL Value</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr><td>Email Marketing</td><td class="text-end">0.1667</td></tr>
                                <tr><td>MQL</td><td class="text-end">1</td></tr>
                                <tr><td>BANT</td><td class="text-end">2.5</td></tr>
                                <tr><td>Appointment</td><td class="text-end">10</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="small">
                        <div class="fw-semibold">Daily Incentive</div>
                        <div class="text-muted">Rs. 500 when Daily % reaches 100%.</div>
                        <div class="fw-semibold mt-2">Extra Incentive (after 100%)</div>
                        <div class="text-muted">MQL: Rs. 100 each, BANT: Rs. 250 each, Appointment: Rs. 1000 each.</div>
                        <div class="text-muted">Email Marketing has no extra-per-lead bonus.</div>
                        <div class="fw-semibold mt-2">Monthly Incentive</div>
                        <div class="text-muted">Rs. 10,000 when Overall % is 90% or more.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-light fw-semibold">Daily Breakdown (Incentive Split)</div>
        <div class="card-body">
                    ...
                    <table class="table table-sm table-striped align-middle">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dailyRows as $row): ?>
                                <?php
                                    ...
                                    $mqlAch = (float)($row['achieved_mql'] ?? 0);
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><?php echo number_format($mqlAch, 2); ?></td>
                        ...
                        <tfoot>
                            <tr class="fw-bold">
                                ...
                                <td class="text-end"><?php echo number_format($sumMqlAch, 2); ?></td>
